    ...
    <div className={active === 'Overview' ? 'app-shell admin-app' : 'app-shell'}>
      ...
      <main className="main-content">
        ...
        {active === 'Webmail' ? <Webmail /> : <>
          {active === 'Accounts' ? <AccountsView accounts={accounts} showAccountForm={showAccountForm} setShowAccountForm={setShowAccountForm} accountForm={accountForm} setAccountForm={setAccountForm} createAccount={createAccount} createdCustomerLink={createdCustomerLink} otpCodes={otpCodes} issueOtp={issueOtp} updateAccount={updateAccount} deleteAccount={deleteAccount} /> : active === 'Payments' ? <PaymentsView transactionForm={transactionForm} setTransactionForm={setTransactionForm} addTransaction={addTransaction} transactions={transactions} setTransactions={setTransactions} /> : active === 'Settings' ? <AdminSettings adminPassword={adminPassword} setAdminPassword={setAdminPassword} setAuditLogs={setAuditLogs} auditLogs={auditLogs} /> : <>
